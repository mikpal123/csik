...
namespace csik
{
    public partial class ss1366 : Form
    {
        ...
        public ss1366(TextBox _text1, TextBox _text2, TextBox _text3, TextBox _text4, TextBox _text5, TextBox _imgText1, TextBox _imgText2, TextBox _imgText3, TextBox _imgText4, TextBox _imgText5)
        {
            InitializeComponent();
            this.text1 = _text1;
            this.text2 = _text2;
